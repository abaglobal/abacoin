...
#if defined(NDEBUG)
# error "Abacoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Abacoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ABAG additional fees, %d delta bytes\n",
