...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s abacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  abacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded abacoin transaction") + "\n" +
              "  abacoin-tx [options] -create [commands]   " + _("Create hex-encoded abacoin transaction") + "\n" +
              "\n";
