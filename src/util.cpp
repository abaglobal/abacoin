...
const char * const BITCOIN_CONF_FILENAME = "abacoin.conf";
const char * const BITCOIN_PID_FILENAME = "abacoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Abacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Abacoin";
#else
    // Unix
    return pathRet / ".abacoin";
#endif
#endif
}
